...
CREATE VIEW NEW_Qlist AS
	SELECT Qnumber, Uid, Title, Content, Ccnt, Good, Cname, Qtime FROM (SELECT Qno, COUNT(*) AS Ccnt FROM mREPLY GROUP BY Qno) R RIGHT JOIN ((SELECT Uid, Qnumber, Title, Content, Good, Cno, Qtime FROM mQUESTION JOIN mASK ON Qno=Qnumber ORDER BY Qtime DESC) Q JOIN mCATEGORY ON Cno=Cnumber) ON Qnumber=Qno ORDER BY Qtime DESC;
SELECT * FROM NEW_Qlist;

DROP VIEW IF EXISTS HOT_Qlist;
CREATE VIEW HOT_Qlist AS
	SELECT Qnumber, Uid, Title, Content, Ccnt, Good, Cname, Qtime FROM (SELECT Qno, COUNT(*) AS Ccnt FROM mREPLY GROUP BY Qno) R RIGHT JOIN (SELECT Uid, Qnumber, Title, Content, Good, Cname, Cnt, Qtime FROM mCATEGORY RIGHT JOIN (SELECT Uid, Qnumber, Title, Content, Cno, Good, Cnt, Qtime FROM mASK JOIN (SELECT Qnumber, Title, Content, Cno, Good, Cnt, Qtime FROM mQUESTION LEFT JOIN (SELECT Qno, COUNT(*) AS Cnt FROM mREPLY GROUP BY Qno ORDER BY COUNT(*) DESC) R ON Qnumber=Qno ORDER BY R.cnt DESC) Q ON Qno=Qnumber) A ON Cno=Cnumber ORDER BY Cnt DESC) Q ON Qno=Qnumber ORDER BY Good DESC;
...
CREATE VIEW Ranking AS
	SELECT C.Id, SUM(Qgood+Cgood) AS Good, Cnt FROM 
	(SELECT Id, Qgood FROM mUSER LEFT JOIN (SELECT Uid, SUM(Good) AS Qgood FROM mASK JOIN mQUESTION ON Qno=Qnumber GROUP BY Uid) Q ON Id=Uid) Q,
	(SELECT Id, Cgood, Cnt FROM mUSER LEFT JOIN (SELECT Uid, SUM(Good) AS Cgood, COUNT(*) AS Cnt FROM mANSWER JOIN mCOMMENT ON Cno=Cnumber GROUP BY Uid) C ON Id=Uid) C
	WHERE C.Id=Q.Id GROUP BY C.Id ORDER BY Good DESC;
SELECT * FROM Ranking;    
...
SELECT * FROM mREPLY;
INSERT INTO mREPLY(Qno, Cno) VALUES (32,1);
INSERT INTO mREPLY(Qno, Cno) VALUES (19,2);
INSERT INTO mREPLY(Qno, Cno) VALUES (12,3);
INSERT INTO mREPLY(Qno, Cno) VALUES (22,4);
INSERT INTO mREPLY(Qno, Cno) VALUES (30,5);
INSERT INTO mREPLY(Qno, Cno) VALUES (33,6);
INSERT INTO mREPLY(Qno, Cno) VALUES (20,7);
INSERT INTO mREPLY(Qno, Cno) VALUES (9,8);
INSERT INTO mREPLY(Qno, Cno) VALUES (29,9);
INSERT INTO mREPLY(Qno, Cno) VALUES (5,10);
INSERT INTO mREPLY(Qno, Cno) VALUES (24,11);
INSERT INTO mREPLY(Qno, Cno) VALUES (25,12);
INSERT INTO mREPLY(Qno, Cno) VALUES (10,13);
INSERT INTO mREPLY(Qno, Cno) VALUES (14,14);
INSERT INTO mREPLY(Qno, Cno) VALUES (11,15);
INSERT INTO mREPLY(Qno, Cno) VALUES (35,16);
INSERT INTO mREPLY(Qno, Cno) VALUES (28,17);
INSERT INTO mREPLY(Qno, Cno) VALUES (10,18);
INSERT INTO mREPLY(Qno, Cno) VALUES (24,19);
INSERT INTO mREPLY(Qno, Cno) VALUES (9,20);
INSERT INTO mREPLY(Qno, Cno) VALUES (28,21);
INSERT INTO mREPLY(Qno, Cno) VALUES (12,22);
INSERT INTO mREPLY(Qno, Cno) VALUES (1,23);
INSERT INTO mREPLY(Qno, Cno) VALUES (30,24);
INSERT INTO mREPLY(Qno, Cno) VALUES (26,25);
INSERT INTO mREPLY(Qno, Cno) VALUES (10,26);
INSERT INTO mREPLY(Qno, Cno) VALUES (17,27);
INSERT INTO mREPLY(Qno, Cno) VALUES (30,28);
INSERT INTO mREPLY(Qno, Cno) VALUES (14,29);
INSERT INTO mREPLY(Qno, Cno) VALUES (33,30);
INSERT INTO mREPLY(Qno, Cno) VALUES (18,31);
INSERT INTO mREPLY(Qno, Cno) VALUES (5,32);
INSERT INTO mREPLY(Qno, Cno) VALUES (12,33);
INSERT INTO mREPLY(Qno, Cno) VALUES (26,34);
INSERT INTO mREPLY(Qno, Cno) VALUES (11,35);
INSERT INTO mREPLY(Qno, Cno) VALUES (26,36);
INSERT INTO mREPLY(Qno, Cno) VALUES (10,37);
INSERT INTO mREPLY(Qno, Cno) VALUES (8,38);
INSERT INTO mREPLY(Qno, Cno) VALUES (19,39);
INSERT INTO mREPLY(Qno, Cno) VALUES (27,40);
INSERT INTO mREPLY(Qno, Cno) VALUES (31,41);
INSERT INTO mREPLY(Qno, Cno) VALUES (26,42);
INSERT INTO mREPLY(Qno, Cno) VALUES (12,43);
INSERT INTO mREPLY(Qno, Cno) VALUES (30,44);
INSERT INTO mREPLY(Qno, Cno) VALUES (31,45);
INSERT INTO mREPLY(Qno, Cno) VALUES (22,46);
INSERT INTO mREPLY(Qno, Cno) VALUES (24,47);
INSERT INTO mREPLY(Qno, Cno) VALUES (21,48);
INSERT INTO mREPLY(Qno, Cno) VALUES (32,49);
INSERT INTO mREPLY(Qno, Cno) VALUES (15,50);
INSERT INTO mREPLY(Qno, Cno) VALUES (12,51);
INSERT INTO mREPLY(Qno, Cno) VALUES (28,52);
INSERT INTO mREPLY(Qno, Cno) VALUES (13,53);
INSERT INTO mREPLY(Qno, Cno) VALUES (23,54);
INSERT INTO mREPLY(Qno, Cno) VALUES (25,55);
INSERT INTO mREPLY(Qno, Cno) VALUES (7,56);
INSERT INTO mREPLY(Qno, Cno) VALUES (16,57);
INSERT INTO mREPLY(Qno, Cno) VALUES (11,58);
INSERT INTO mREPLY(Qno, Cno) VALUES (17,59);
INSERT INTO mREPLY(Qno, Cno) VALUES (4,60);
INSERT INTO mREPLY(Qno, Cno) VALUES (9,61);
INSERT INTO mREPLY(Qno, Cno) VALUES (23,62);
INSERT INTO mREPLY(Qno, Cno) VALUES (7,63);
INSERT INTO mREPLY(Qno, Cno) VALUES (33,64);
INSERT INTO mREPLY(Qno, Cno) VALUES (6,65);
INSERT INTO mREPLY(Qno, Cno) VALUES (18,66);
INSERT INTO mREPLY(Qno, Cno) VALUES (25,67);
INSERT INTO mREPLY(Qno, Cno) VALUES (32,68);
INSERT INTO mREPLY(Qno, Cno) VALUES (24,69);
INSERT INTO mREPLY(Qno, Cno) VALUES (15,70);
INSERT INTO mREPLY(Qno, Cno) VALUES (28,71);
INSERT INTO mREPLY(Qno, Cno) VALUES (19,72);
INSERT INTO mREPLY(Qno, Cno) VALUES (8,73);
INSERT INTO mREPLY(Qno, Cno) VALUES (2,74);
INSERT INTO mREPLY(Qno, Cno) VALUES (29,75);
INSERT INTO mREPLY(Qno, Cno) VALUES (4,76);
INSERT INTO mREPLY(Qno, Cno) VALUES (15,77);
INSERT INTO mREPLY(Qno, Cno) VALUES (1,78);
INSERT INTO mREPLY(Qno, Cno) VALUES (20,79);
INSERT INTO mREPLY(Qno, Cno) VALUES (9,80);
INSERT INTO mREPLY(Qno, Cno) VALUES (34,81);
INSERT INTO mREPLY(Qno, Cno) VALUES (4,82);
INSERT INTO mREPLY(Qno, Cno) VALUES (30,83);
INSERT INTO mREPLY(Qno, Cno) VALUES (13,84);
INSERT INTO mREPLY(Qno, Cno) VALUES (31,85);
INSERT INTO mREPLY(Qno, Cno) VALUES (23,86);
INSERT INTO mREPLY(Qno, Cno) VALUES (21,87);
INSERT INTO mREPLY(Qno, Cno) VALUES (20,88);
INSERT INTO mREPLY(Qno, Cno) VALUES (34,89);
INSERT INTO mREPLY(Qno, Cno) VALUES (7,90);
INSERT INTO mREPLY(Qno, Cno) VALUES (30,91);
INSERT INTO mREPLY(Qno, Cno) VALUES (7,92);
INSERT INTO mREPLY(Qno, Cno) VALUES (5,93);
INSERT INTO mREPLY(Qno, Cno) VALUES (16,94);
INSERT INTO mREPLY(Qno, Cno) VALUES (25,95);
INSERT INTO mREPLY(Qno, Cno) VALUES (17,96);
INSERT INTO mREPLY(Qno, Cno) VALUES (24,97);
INSERT INTO mREPLY(Qno, Cno) VALUES (19,98);
INSERT INTO mREPLY(Qno, Cno) VALUES (24,99);
INSERT INTO mREPLY(Qno, Cno) VALUES (17,100);
INSERT INTO mREPLY(Qno, Cno) VALUES (22,101);
INSERT INTO mREPLY(Qno, Cno) VALUES (8,102);
INSERT INTO mREPLY(Qno, Cno) VALUES (11,103);
INSERT INTO mREPLY(Qno, Cno) VALUES (34,104);
INSERT INTO mREPLY(Qno, Cno) VALUES (33,105);
INSERT INTO mREPLY(Qno, Cno) VALUES (11,106);
INSERT INTO mREPLY(Qno, Cno) VALUES (33,107);
